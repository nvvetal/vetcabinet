...
class LoginSocialAuthHandler implements AuthenticationSuccessHandlerInterface, AuthenticationFailureHandlerInterface
{
    protected $router;
    protected $security;
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token)
    {
        ...
        return new RedirectResponse($this->router->generate('login_social_success'));
    }
